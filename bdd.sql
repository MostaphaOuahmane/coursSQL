...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 04 jan. 2022 à 11:21
...
--
-- Base de données : `aprendre`
--
CREATE DATABASE IF NOT EXISTS `aprendre` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `aprendre`;
...
INSERT INTO `personne` (`PersonneID`, `Prenom`, `Nom`, `Adresse`, `Ville`, `Pays`) VALUES
(1, 'Mostapha', 'Ouahmane', '11 Rue Barbara Pantin 93500', 'Paris', 'France'),
(2, 'Malika', 'Ait Taouil', '31 Rue Des ombraies Nanterre 92000', 'Paris', 'France');
--
-- Base de données : `aprrendresql`
--
CREATE DATABASE IF NOT EXISTS `aprrendresql` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `aprrendresql`;
...
--
ALTER TABLE `produit`
  MODIFY `prduit` int(11) NOT NULL AUTO_INCREMENT;
--
...
(992, 'Jeanne', 'Richy', 'f', 'commercial', '2021-01-28', 2000);
